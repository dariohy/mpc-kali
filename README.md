...
**Project status:** `v2.4.0` is the current stable release. Version 2.1.0 was
...
at `~/.mcp-kali/plugins/codex` and `~/.mcp-kali/plugins/mcp-kali.mcpb`; both
builders use the installed `~/.mcp-kali/bin/mcp-kali-bridge`.
